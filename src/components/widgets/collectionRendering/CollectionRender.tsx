import { mdiCalendar, mdiCards, mdiTable } from "@mdi/js";
import Icon from "@mdi/react";
import React, { useState } from "react";
import { Col, Row } from "react-bootstrap";
import { EloiseWidget, Heading, useEloise } from "../../..";
...
function determineDisplayType(obj: unknown): DisplayType[] {
  ...
  return Object.keys(displayOptions).reduce(
    (acc: DisplayType[], displayType: string) => {
